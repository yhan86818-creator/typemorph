...
files.forEach(f => {
  ...
  if (c.toLowerCase().includes('typemorph')) typemorph.push(f);
...
console.log('=== Still says "TypeMorph" (branding bug) ===');
typemorph.forEach(f => console.log(' ', f));
console.log(`Total: ${typemorph.length}\n`);
