...
export const metadata: Metadata = {
  title: 'TypeMorph Finance | Secure SWIFT MT/MX & FIX Protocol Parser for Enterprises',
  ...
  alternates: {
    canonical: 'https://typemorph.dev/finance',
  },
  openGraph: {
    title: 'TypeMorph Finance | SWIFT MT/MX & FIX Protocol Parser',
    ...
    url: 'https://typemorph.dev/finance',
    siteName: 'TypeMorph',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'TypeMorph Finance | Secure SWIFT & FIX Protocol Workbench',
