        ...
        <div className="fixed inset-0 z-[600] flex items-center justify-center p-6">
          ...
          >
            ...
            <div className="mb-8">
              ...
              <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">Join the community and help shape TypeFlow.</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <a
                ...
                className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-black py-4 rounded-2xl shadow-lg shadow-indigo-500/20 flex items-center justify-center gap-3 transition-all active:scale-95 group"
              >
              ...
              {/* GitHub Issues */}
              <a
                href="https://github.com/yhanster206"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full bg-slate-900 dark:bg-slate-800 hover:bg-slate-800 dark:hover:bg-slate-700 text-white font-black py-4 rounded-2xl flex items-center justify-center gap-3 transition-all active:scale-95 group"
              >
              ...
              {/* Twitter/X */}
              <a
                href="https://twitter.com/intent/tweet?text=@yhanster206%20"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <p className="mt-6 text-center text-[9px] text-slate-400 font-medium">
              We read every message. Thank you for making TypeFlow better. 🙏
            </p>
          </motion.div>
        </div>
      )}
