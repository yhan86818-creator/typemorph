...
export const converters: Converter[] = [
  ...
  {
    "category": "AI & LLM Tools",
    "slug": "json-to-llm-validator",
    "title": "JSON to LLM Response Validator — Zod safeParse for AI Outputs (2026)",
    "description": "Generate a Zod schema + safeParse function from any LLM JSON response. Catch ChatGPT, Claude, and Gemini type errors before they crash your app. Works with OpenAI, Anthropic, and Vercel AI SDK.",
    "h1": "LLM Response Validator: Generate Type-Safe Zod Validators for AI Outputs"
  },
  {
    "category": "Web & Frontend",
    "slug": "json-to-type-guard",
    "title": "Convert JSON to TypeScript Type Guards - Runtime Type Safety Without Dependencies",
    "description": "Generate TypeScript is<Type>() type guard functions from JSON. Zero runtime dependencies — pure TypeScript type narrowing for safe API response validation.",
    "h1": "JSON to TypeScript Type Guards: Generate Runtime Type Checks Instantly"
  }
]
